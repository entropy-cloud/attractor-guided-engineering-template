import{X as tt,g as f,l as A,j as V,d as L,h as a,b as me,Y as nt,Z as ot,$ as G,a0 as rt,a1 as it,a2 as st,a3 as lt,n as ce,a4 as at,e as we,f as T,a5 as ct,a6 as J,a7 as dt,a8 as ut,N as Oe,a9 as Ae,W as Ee,aa as Fe,ab as Le,ac as pt,ad as ie,ae as mt,c as ft,v as gt,a as Se,r as $e,i as ht,af as vt,w as g,x as R,E as B,z as qe,I,G as n,J as ne,F as k,P as le,R as ue,ag as Ce,ah as We,Q as P,K as O,B as K,ai as Z,M as E,D as C,T as X,U as Q,aj as Ve,ak as Ge,q as F,V as te,_ as pe,S as ae,al as bt,am as Ke,an as ke,ao as yt,H as He,ap as be,A as Ue,C as Xe,aq as wt,ar as kt,as as xt,at as St,O as $t,au as Ct,av as _t}from"./index-BXlkLssv.js";import{b as zt,_ as ee,a as ye,c as Pt,e as Rt,f as It,h as Nt,i as _e,A as Bt}from"./index-3RZDE2zp.js";import{u as ve}from"./config-DQyoe7sK.js";import{x as Ye,a as Je,b as Tt}from"./xterm-DRSot3bM.js";import{_ as Mt,C as Dt}from"./ChevronDown-BWZQ-a5a.js";let ze=!1;function jt(){if(tt&&window.CSS&&!ze&&(ze=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function Pe(e,s="default",t=[]){const{children:p}=e;if(p!==null&&typeof p=="object"&&!Array.isArray(p)){const r=p[s];if(typeof r=="function")return r()}return t}const Ot=f("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
