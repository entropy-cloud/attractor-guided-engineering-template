 ...
 * the real mission-control service, the real DSH agents face (the `subagent`
...
if (process.env.DSH_E2E_CONTINUOUS !== "1") {
  ...
  console.error("  real-host three-leg run: DSH_E2E_CONTINUOUS=1 pnpm --prefix plugin/dsh run verify:e2e:continuous");
