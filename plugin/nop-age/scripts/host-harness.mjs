 ...
 * workspace") is L4/WI10 scope: this composition runs no nop-age
...
function resolveBinPath() {
  ...
  if (!existsSync(binLink)) {
    throw new Error(`demo bin not found at ${binLink} — run \`npm install\` in plugin/nop-age (Phase 1 devDeps)`);
  }
