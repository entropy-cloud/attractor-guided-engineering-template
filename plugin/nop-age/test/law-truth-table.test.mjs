...
test("p8: the four protected families deny AI writes with the exception channels listed", () => {
  for (const path of [
    "/r/plugin/nop-age/src/law/host-adapter.ts",
    "/r/plugin/nop-age/src/law/deep/nested/rule.ts",
  ...
  assert.ok(isLawProtectedPath("/r/plugin/nop-age/src/law/host-adapter.ts", "/r"));
  assert.equal(isLawProtectedPath("/r/plugin/nop-age/src/engine-bridge.ts", "/r"), false);
